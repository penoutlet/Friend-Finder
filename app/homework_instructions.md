...
6. Determine the user's most compatible friend using the following as a guide:le array of numbers (ex: `[5, 1, 4, 4, 5, 1, 2, 5, 4, 

   * Convert each user's results into a simp1]`).
